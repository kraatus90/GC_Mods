...
.method public constructor <init>()V
    ...
    invoke-direct {p0, v1, v0}, Lorg/apache/http/impl/auth/NegotiateScheme;-><init>(Lorg/apache/http/impl/auth/SpnegoTokenGenerator;Z)V
...
.method protected a([BLjava/lang/String;)[B
    ...
    const-string/jumbo v2, "1.3.6.1.5.5.2"

    invoke-direct {v1, v2}, Lorg/ietf/jgss/Oid;-><init>(Ljava/lang/String;)V

    :try_start_0
    invoke-virtual {p0, p1, v1, p2}, Lorg/apache/http/impl/auth/NegotiateScheme;->a([BLorg/ietf/jgss/Oid;Ljava/lang/String;)[B
    :try_end_0
    ...
    const-string/jumbo v2, "Using Kerberos MECH 1.2.840.113554.1.2.2"

    invoke-interface {v1, v2}, Lorg/apache/commons/logging/Log;->debug(Ljava/lang/Object;)V

    new-instance v1, Lorg/ietf/jgss/Oid;

    const-string/jumbo v2, "1.2.840.113554.1.2.2"

    invoke-direct {v1, v2}, Lorg/ietf/jgss/Oid;-><init>(Ljava/lang/String;)V

    invoke-virtual {p0, v0, v1, p2}, Lorg/apache/http/impl/auth/NegotiateScheme;->a([BLorg/ietf/jgss/Oid;Ljava/lang/String;)[B
