...
.field protected final b:Lorg/apache/http/impl/conn/tsccm/AbstractConnPool;

.field protected final c:Lorg/apache/http/impl/conn/tsccm/ConnPoolByRoute;

.field protected final d:Lorg/apache/http/conn/ClientConnectionOperator;

.field protected final e:Lorg/apache/http/conn/params/ConnPerRouteBean;
...
.method public constructor <init>(Lorg/apache/http/conn/scheme/SchemeRegistry;JLjava/util/concurrent/TimeUnit;Lorg/apache/http/conn/params/ConnPerRouteBean;)V
    ...
    iput-object p1, p0, Lorg/apache/http/impl/conn/tsccm/ThreadSafeClientConnManager;->a:Lorg/apache/http/conn/scheme/SchemeRegistry;

    iput-object p5, p0, Lorg/apache/http/impl/conn/tsccm/ThreadSafeClientConnManager;->e:Lorg/apache/http/conn/params/ConnPerRouteBean;

    invoke-virtual {p0, p1}, Lorg/apache/http/impl/conn/tsccm/ThreadSafeClientConnManager;->a(Lorg/apache/http/conn/scheme/SchemeRegistry;)Lorg/apache/http/conn/ClientConnectionOperator;

    move-result-object v0

    iput-object v0, p0, Lorg/apache/http/impl/conn/tsccm/ThreadSafeClientConnManager;->d:Lorg/apache/http/conn/ClientConnectionOperator;

    invoke-virtual {p0, p2, p3, p4}, Lorg/apache/http/impl/conn/tsccm/ThreadSafeClientConnManager;->a(JLjava/util/concurrent/TimeUnit;)Lorg/apache/http/impl/conn/tsccm/ConnPoolByRoute;

    move-result-object v0

    iput-object v0, p0, Lorg/apache/http/impl/conn/tsccm/ThreadSafeClientConnManager;->c:Lorg/apache/http/impl/conn/tsccm/ConnPoolByRoute;

    iget-object v0, p0, Lorg/apache/http/impl/conn/tsccm/ThreadSafeClientConnManager;->c:Lorg/apache/http/impl/conn/tsccm/ConnPoolByRoute;

    iput-object v0, p0, Lorg/apache/http/impl/conn/tsccm/ThreadSafeClientConnManager;->b:Lorg/apache/http/impl/conn/tsccm/AbstractConnPool;
...
.method public constructor <init>(Lorg/apache/http/params/HttpParams;Lorg/apache/http/conn/scheme/SchemeRegistry;)V
    ...
    iput-object p2, p0, Lorg/apache/http/impl/conn/tsccm/ThreadSafeClientConnManager;->a:Lorg/apache/http/conn/scheme/SchemeRegistry;

    new-instance v0, Lorg/apache/http/conn/params/ConnPerRouteBean;

    invoke-direct {v0}, Lorg/apache/http/conn/params/ConnPerRouteBean;-><init>()V

    iput-object v0, p0, Lorg/apache/http/impl/conn/tsccm/ThreadSafeClientConnManager;->e:Lorg/apache/http/conn/params/ConnPerRouteBean;

    invoke-virtual {p0, p2}, Lorg/apache/http/impl/conn/tsccm/ThreadSafeClientConnManager;->a(Lorg/apache/http/conn/scheme/SchemeRegistry;)Lorg/apache/http/conn/ClientConnectionOperator;

    move-result-object v0

    iput-object v0, p0, Lorg/apache/http/impl/conn/tsccm/ThreadSafeClientConnManager;->d:Lorg/apache/http/conn/ClientConnectionOperator;

    invoke-virtual {p0, p1}, Lorg/apache/http/impl/conn/tsccm/ThreadSafeClientConnManager;->a(Lorg/apache/http/params/HttpParams;)Lorg/apache/http/impl/conn/tsccm/AbstractConnPool;
...
.method static synthetic a(Lorg/apache/http/impl/conn/tsccm/ThreadSafeClientConnManager;)Lorg/apache/commons/logging/Log;
    .locals 1
...
.method protected a(Lorg/apache/http/params/HttpParams;)Lorg/apache/http/impl/conn/tsccm/AbstractConnPool;
    .locals 2
    .annotation runtime Ljava/lang/Deprecated;
    .end annotation
    ...
    iget-object v1, p0, Lorg/apache/http/impl/conn/tsccm/ThreadSafeClientConnManager;->d:Lorg/apache/http/conn/ClientConnectionOperator;
...
.method protected a(JLjava/util/concurrent/TimeUnit;)Lorg/apache/http/impl/conn/tsccm/ConnPoolByRoute;
    .locals 7
    ...
    iget-object v2, p0, Lorg/apache/http/impl/conn/tsccm/ThreadSafeClientConnManager;->e:Lorg/apache/http/conn/params/ConnPerRouteBean;
...
.method public getDefaultMaxPerRoute()I
    ...
    iget-object v0, p0, Lorg/apache/http/impl/conn/tsccm/ThreadSafeClientConnManager;->e:Lorg/apache/http/conn/params/ConnPerRouteBean;
...
.method public getSchemeRegistry()Lorg/apache/http/conn/scheme/SchemeRegistry;
    ...
    iget-object v0, p0, Lorg/apache/http/impl/conn/tsccm/ThreadSafeClientConnManager;->a:Lorg/apache/http/conn/scheme/SchemeRegistry;
...
.method public releaseConnection(Lorg/apache/http/conn/ManagedClientConnection;JLjava/util/concurrent/TimeUnit;)V
    ...
    const-string/jumbo v2, "Connection class mismatch, connection not obtained from this manager"
    ...
    invoke-virtual {p1}, Lorg/apache/http/impl/conn/tsccm/BasicPooledConnAdapter;->f()Lorg/apache/http/impl/conn/AbstractPoolEntry;
    ...
    :goto_2
    invoke-virtual {p1}, Lorg/apache/http/impl/conn/tsccm/BasicPooledConnAdapter;->a()V

    iget-object v1, p0, Lorg/apache/http/impl/conn/tsccm/ThreadSafeClientConnManager;->c:Lorg/apache/http/impl/conn/tsccm/ConnPoolByRoute;
    ...
    :cond_1
    invoke-virtual {p1}, Lorg/apache/http/impl/conn/tsccm/BasicPooledConnAdapter;->c()Lorg/apache/http/conn/ClientConnectionManager;
