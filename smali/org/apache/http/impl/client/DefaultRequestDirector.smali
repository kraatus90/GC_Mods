...
# instance fields
.field protected final a:Lorg/apache/http/conn/ClientConnectionManager;

.field private final authenticator:Lorg/apache/http/impl/client/HttpAuthenticator;

.field protected final b:Lorg/apache/http/conn/routing/HttpRoutePlanner;

.field protected final c:Lorg/apache/http/ConnectionReuseStrategy;

.field protected final d:Lorg/apache/http/conn/ConnectionKeepAliveStrategy;

.field protected final e:Lorg/apache/http/protocol/HttpRequestExecutor;

.field private execCount:I

.field protected final f:Lorg/apache/http/protocol/HttpProcessor;

.field protected final g:Lorg/apache/http/client/HttpRequestRetryHandler;

.field protected final h:Lorg/apache/http/client/RedirectHandler;
    .annotation runtime Ljava/lang/Deprecated;
    .end annotation
.end field

.field protected final i:Lorg/apache/http/client/RedirectStrategy;

.field protected final j:Lorg/apache/http/client/AuthenticationHandler;
    .annotation runtime Ljava/lang/Deprecated;
    .end annotation
.end field

.field protected final k:Lorg/apache/http/client/AuthenticationStrategy;

.field protected final l:Lorg/apache/http/client/AuthenticationHandler;
    .annotation runtime Ljava/lang/Deprecated;
    .end annotation
.end field
...
.field protected final m:Lorg/apache/http/client/AuthenticationStrategy;

.field private final maxRedirects:I

.field protected final n:Lorg/apache/http/client/UserTokenHandler;

.field protected final o:Lorg/apache/http/params/HttpParams;

.field protected p:Lorg/apache/http/conn/ManagedClientConnection;

.field protected final q:Lorg/apache/http/auth/AuthState;

.field protected final r:Lorg/apache/http/auth/AuthState;
...
.method public constructor <init>(Lorg/apache/commons/logging/Log;Lorg/apache/http/protocol/HttpRequestExecutor;Lorg/apache/http/conn/ClientConnectionManager;Lorg/apache/http/ConnectionReuseStrategy;Lorg/apache/http/conn/ConnectionKeepAliveStrategy;Lorg/apache/http/conn/routing/HttpRoutePlanner;Lorg/apache/http/protocol/HttpProcessor;Lorg/apache/http/client/HttpRequestRetryHandler;Lorg/apache/http/client/RedirectStrategy;Lorg/apache/http/client/AuthenticationStrategy;Lorg/apache/http/client/AuthenticationStrategy;Lorg/apache/http/client/UserTokenHandler;Lorg/apache/http/params/HttpParams;)V
    ...
    iput-object p2, p0, Lorg/apache/http/impl/client/DefaultRequestDirector;->e:Lorg/apache/http/protocol/HttpRequestExecutor;

    iput-object p3, p0, Lorg/apache/http/impl/client/DefaultRequestDirector;->a:Lorg/apache/http/conn/ClientConnectionManager;

    iput-object p4, p0, Lorg/apache/http/impl/client/DefaultRequestDirector;->c:Lorg/apache/http/ConnectionReuseStrategy;

    iput-object p5, p0, Lorg/apache/http/impl/client/DefaultRequestDirector;->d:Lorg/apache/http/conn/ConnectionKeepAliveStrategy;

    iput-object p6, p0, Lorg/apache/http/impl/client/DefaultRequestDirector;->b:Lorg/apache/http/conn/routing/HttpRoutePlanner;

    iput-object p7, p0, Lorg/apache/http/impl/client/DefaultRequestDirector;->f:Lorg/apache/http/protocol/HttpProcessor;

    iput-object p8, p0, Lorg/apache/http/impl/client/DefaultRequestDirector;->g:Lorg/apache/http/client/HttpRequestRetryHandler;

    iput-object p9, p0, Lorg/apache/http/impl/client/DefaultRequestDirector;->i:Lorg/apache/http/client/RedirectStrategy;

    iput-object p10, p0, Lorg/apache/http/impl/client/DefaultRequestDirector;->k:Lorg/apache/http/client/AuthenticationStrategy;

    iput-object p11, p0, Lorg/apache/http/impl/client/DefaultRequestDirector;->m:Lorg/apache/http/client/AuthenticationStrategy;

    move-object/from16 v0, p12

    iput-object v0, p0, Lorg/apache/http/impl/client/DefaultRequestDirector;->n:Lorg/apache/http/client/UserTokenHandler;

    move-object/from16 v0, p13

    iput-object v0, p0, Lorg/apache/http/impl/client/DefaultRequestDirector;->o:Lorg/apache/http/params/HttpParams;
    ...
    iput-object v1, p0, Lorg/apache/http/impl/client/DefaultRequestDirector;->h:Lorg/apache/http/client/RedirectHandler;
    ...
    iput-object v1, p0, Lorg/apache/http/impl/client/DefaultRequestDirector;->j:Lorg/apache/http/client/AuthenticationHandler;
    ...
    iput-object v1, p0, Lorg/apache/http/impl/client/DefaultRequestDirector;->l:Lorg/apache/http/client/AuthenticationHandler;

    :goto_2
    const/4 v1, 0x0

    iput-object v1, p0, Lorg/apache/http/impl/client/DefaultRequestDirector;->p:Lorg/apache/http/conn/ManagedClientConnection;
    ...
    iput-object v1, p0, Lorg/apache/http/impl/client/DefaultRequestDirector;->q:Lorg/apache/http/auth/AuthState;

    new-instance v1, Lorg/apache/http/auth/AuthState;

    invoke-direct {v1}, Lorg/apache/http/auth/AuthState;-><init>()V

    iput-object v1, p0, Lorg/apache/http/impl/client/DefaultRequestDirector;->r:Lorg/apache/http/auth/AuthState;

    iget-object v1, p0, Lorg/apache/http/impl/client/DefaultRequestDirector;->o:Lorg/apache/http/params/HttpParams;
...
.method private abortConnection()V
    ...
    iget-object v0, p0, Lorg/apache/http/impl/client/DefaultRequestDirector;->p:Lorg/apache/http/conn/ManagedClientConnection;
...
.method private tryConnect(Lorg/apache/http/impl/client/RoutedRequest;Lorg/apache/http/protocol/HttpContext;)V
    ...
    :try_start_0
    iget-object v1, p0, Lorg/apache/http/impl/client/DefaultRequestDirector;->p:Lorg/apache/http/conn/ManagedClientConnection;
    ...
    iget-object v4, p0, Lorg/apache/http/impl/client/DefaultRequestDirector;->o:Lorg/apache/http/params/HttpParams;
    ...
    :goto_1
    invoke-virtual {p0, v2, p2}, Lorg/apache/http/impl/client/DefaultRequestDirector;->a(Lorg/apache/http/conn/routing/HttpRoute;Lorg/apache/http/protocol/HttpContext;)V
    ...
    :try_start_1
    iget-object v4, p0, Lorg/apache/http/impl/client/DefaultRequestDirector;->p:Lorg/apache/http/conn/ManagedClientConnection;
    ...
    :goto_2
    iget-object v4, p0, Lorg/apache/http/impl/client/DefaultRequestDirector;->g:Lorg/apache/http/client/HttpRequestRetryHandler;
    ...
    const-string/jumbo v6, ") caught when connecting to the target host: "
    ...
    const-string/jumbo v4, "Retrying connect"
...
.method private tryExecute(Lorg/apache/http/impl/client/RoutedRequest;Lorg/apache/http/protocol/HttpContext;)Lorg/apache/http/HttpResponse;
    ...
    :goto_2
    iget-object v0, p0, Lorg/apache/http/impl/client/DefaultRequestDirector;->e:Lorg/apache/http/protocol/HttpRequestExecutor;
    ...
    const-string/jumbo v5, "Retrying request"
    ...
    const-string/jumbo v6, ") caught when processing request: "
...
# virtual methods
.method protected a(Lorg/apache/http/HttpHost;Lorg/apache/http/HttpRequest;Lorg/apache/http/protocol/HttpContext;)Lorg/apache/http/conn/routing/HttpRoute;
    .locals 3

    iget-object v1, p0, Lorg/apache/http/impl/client/DefaultRequestDirector;->b:Lorg/apache/http/conn/routing/HttpRoutePlanner;
...
.method protected a(Lorg/apache/http/impl/client/RoutedRequest;Lorg/apache/http/HttpResponse;Lorg/apache/http/protocol/HttpContext;)Lorg/apache/http/impl/client/RoutedRequest;
    .locals 10
    ...
    iget-object v3, p0, Lorg/apache/http/impl/client/DefaultRequestDirector;->k:Lorg/apache/http/client/AuthenticationStrategy;

    iget-object v4, p0, Lorg/apache/http/impl/client/DefaultRequestDirector;->q:Lorg/apache/http/auth/AuthState;
    ...
    iget-object v3, p0, Lorg/apache/http/impl/client/DefaultRequestDirector;->m:Lorg/apache/http/client/AuthenticationStrategy;

    iget-object v4, p0, Lorg/apache/http/impl/client/DefaultRequestDirector;->r:Lorg/apache/http/auth/AuthState;
    ...
    :cond_5
    iget-object v1, p0, Lorg/apache/http/impl/client/DefaultRequestDirector;->a:Lorg/apache/http/conn/ClientConnectionManager;
    ...
    :cond_8
    iget-object v0, p0, Lorg/apache/http/impl/client/DefaultRequestDirector;->i:Lorg/apache/http/client/RedirectStrategy;

    invoke-interface {v0, v7, p2, p3}, Lorg/apache/http/client/RedirectStrategy;->isRedirected(Lorg/apache/http/HttpRequest;Lorg/apache/http/HttpResponse;Lorg/apache/http/protocol/HttpContext;)Z
    ...
    iput-object v9, p0, Lorg/apache/http/impl/client/DefaultRequestDirector;->virtualHost:Lorg/apache/http/HttpHost;

    iget-object v0, p0, Lorg/apache/http/impl/client/DefaultRequestDirector;->i:Lorg/apache/http/client/RedirectStrategy;

    invoke-interface {v0, v7, p2, p3}, Lorg/apache/http/client/RedirectStrategy;->getRedirect(Lorg/apache/http/HttpRequest;Lorg/apache/http/HttpResponse;Lorg/apache/http/protocol/HttpContext;)Lorg/apache/http/client/methods/HttpUriRequest;
    ...
    invoke-virtual {v0, v8}, Lorg/apache/http/impl/client/RequestWrapper;->setParams(Lorg/apache/http/params/HttpParams;)V

    invoke-virtual {p0, v2, v0, p3}, Lorg/apache/http/impl/client/DefaultRequestDirector;->a(Lorg/apache/http/HttpHost;Lorg/apache/http/HttpRequest;Lorg/apache/http/protocol/HttpContext;)Lorg/apache/http/conn/routing/HttpRoute;

    move-result-object v2

    new-instance v3, Lorg/apache/http/impl/client/RoutedRequest;

    invoke-direct {v3, v0, v2}, Lorg/apache/http/impl/client/RoutedRequest;-><init>(Lorg/apache/http/impl/client/RequestWrapper;Lorg/apache/http/conn/routing/HttpRoute;)V
    ...
    const-string/jumbo v2, "Maximum redirects ("
    ...
    const-string/jumbo v3, "Redirect URI does not specify a valid host name: "
    ...
    const-string/jumbo v4, "Resetting target auth state"

    invoke-interface {v3, v4}, Lorg/apache/commons/logging/Log;->debug(Ljava/lang/Object;)V

    iget-object v3, p0, Lorg/apache/http/impl/client/DefaultRequestDirector;->q:Lorg/apache/http/auth/AuthState;

    invoke-virtual {v3}, Lorg/apache/http/auth/AuthState;->reset()V

    iget-object v3, p0, Lorg/apache/http/impl/client/DefaultRequestDirector;->r:Lorg/apache/http/auth/AuthState;
    ...
    const-string/jumbo v4, "Resetting proxy auth state"
...
.method protected a()V
    ...
    :goto_0
    iput-object v3, p0, Lorg/apache/http/impl/client/DefaultRequestDirector;->p:Lorg/apache/http/conn/ManagedClientConnection;
...
.method protected a(Lorg/apache/http/conn/routing/HttpRoute;Lorg/apache/http/protocol/HttpContext;)V
    .locals 6
    ...
    iget-object v3, p0, Lorg/apache/http/impl/client/DefaultRequestDirector;->o:Lorg/apache/http/params/HttpParams;
    ...
    :pswitch_2
    invoke-virtual {p0, p1, p2}, Lorg/apache/http/impl/client/DefaultRequestDirector;->b(Lorg/apache/http/conn/routing/HttpRoute;Lorg/apache/http/protocol/HttpContext;)Z
    ...
    iget-object v3, p0, Lorg/apache/http/impl/client/DefaultRequestDirector;->p:Lorg/apache/http/conn/ManagedClientConnection;
    ...
    invoke-virtual {p0, p1, v1, p2}, Lorg/apache/http/impl/client/DefaultRequestDirector;->a(Lorg/apache/http/conn/routing/HttpRoute;ILorg/apache/http/protocol/HttpContext;)Z
    ...
    iget-object v5, p0, Lorg/apache/http/impl/client/DefaultRequestDirector;->o:Lorg/apache/http/params/HttpParams;
...
.method protected a(Lorg/apache/http/impl/client/RequestWrapper;Lorg/apache/http/conn/routing/HttpRoute;)V
    .locals 4
...
.method protected a(Lorg/apache/http/conn/routing/HttpRoute;ILorg/apache/http/protocol/HttpContext;)Z
    .locals 2
...
.method protected b(Lorg/apache/http/conn/routing/HttpRoute;Lorg/apache/http/protocol/HttpContext;)Z
    .locals 8
    ...
    :goto_1
    invoke-virtual {p0, p1, p2}, Lorg/apache/http/impl/client/DefaultRequestDirector;->c(Lorg/apache/http/conn/routing/HttpRoute;Lorg/apache/http/protocol/HttpContext;)Lorg/apache/http/HttpRequest;

    move-result-object v0

    iget-object v2, p0, Lorg/apache/http/impl/client/DefaultRequestDirector;->o:Lorg/apache/http/params/HttpParams;
    ...
    iget-object v2, p0, Lorg/apache/http/impl/client/DefaultRequestDirector;->e:Lorg/apache/http/protocol/HttpRequestExecutor;

    iget-object v3, p0, Lorg/apache/http/impl/client/DefaultRequestDirector;->f:Lorg/apache/http/protocol/HttpProcessor;
    ...
    iget-object v0, p0, Lorg/apache/http/impl/client/DefaultRequestDirector;->o:Lorg/apache/http/params/HttpParams;
    ...
    iget-object v0, p0, Lorg/apache/http/impl/client/DefaultRequestDirector;->c:Lorg/apache/http/ConnectionReuseStrategy;
...
.method protected c(Lorg/apache/http/conn/routing/HttpRoute;Lorg/apache/http/protocol/HttpContext;)Lorg/apache/http/HttpRequest;
    .locals 4
    ...
    :cond_0
    iget-object v0, p0, Lorg/apache/http/impl/client/DefaultRequestDirector;->a:Lorg/apache/http/conn/ClientConnectionManager;
...
.method public execute(Lorg/apache/http/HttpHost;Lorg/apache/http/HttpRequest;Lorg/apache/http/protocol/HttpContext;)Lorg/apache/http/HttpResponse;
    ...
    invoke-virtual {p0, p1, v3, v0}, Lorg/apache/http/impl/client/DefaultRequestDirector;->a(Lorg/apache/http/HttpHost;Lorg/apache/http/HttpRequest;Lorg/apache/http/protocol/HttpContext;)Lorg/apache/http/conn/routing/HttpRoute;
    ...
    :goto_3
    :try_start_0
    invoke-virtual {p0}, Lorg/apache/http/impl/client/DefaultRequestDirector;->a()V
    :try_end_0
    ...
    iget-object v2, p0, Lorg/apache/http/impl/client/DefaultRequestDirector;->p:Lorg/apache/http/conn/ManagedClientConnection;
    ...
    invoke-virtual {p0, v7, v9}, Lorg/apache/http/impl/client/DefaultRequestDirector;->a(Lorg/apache/http/impl/client/RequestWrapper;Lorg/apache/http/conn/routing/HttpRoute;)V

    const-string/jumbo v2, "http.target_host"

    move-object/from16 v0, p3

    invoke-interface {v0, v2, v6}, Lorg/apache/http/protocol/HttpContext;->setAttribute(Ljava/lang/String;Ljava/lang/Object;)V

    const-string/jumbo v2, "http.route"

    move-object/from16 v0, p3

    invoke-interface {v0, v2, v9}, Lorg/apache/http/protocol/HttpContext;->setAttribute(Ljava/lang/String;Ljava/lang/Object;)V

    const-string/jumbo v2, "http.connection"

    iget-object v9, p0, Lorg/apache/http/impl/client/DefaultRequestDirector;->p:Lorg/apache/http/conn/ManagedClientConnection;
    ...
    iget-object v9, p0, Lorg/apache/http/impl/client/DefaultRequestDirector;->f:Lorg/apache/http/protocol/HttpProcessor;

    move-object/from16 v0, p3

    invoke-virtual {v2, v7, v9, v0}, Lorg/apache/http/protocol/HttpRequestExecutor;->preProcess(Lorg/apache/http/HttpRequest;Lorg/apache/http/protocol/HttpProcessor;Lorg/apache/http/protocol/HttpContext;)V
    ...
    iget-object v8, p0, Lorg/apache/http/impl/client/DefaultRequestDirector;->f:Lorg/apache/http/protocol/HttpProcessor;

    move-object/from16 v0, p3

    invoke-virtual {v2, v7, v8, v0}, Lorg/apache/http/protocol/HttpRequestExecutor;->postProcess(Lorg/apache/http/HttpResponse;Lorg/apache/http/protocol/HttpProcessor;Lorg/apache/http/protocol/HttpContext;)V

    iget-object v2, p0, Lorg/apache/http/impl/client/DefaultRequestDirector;->c:Lorg/apache/http/ConnectionReuseStrategy;
    ...
    invoke-virtual {p0, v5, v7, v0}, Lorg/apache/http/impl/client/DefaultRequestDirector;->a(Lorg/apache/http/impl/client/RoutedRequest;Lorg/apache/http/HttpResponse;Lorg/apache/http/protocol/HttpContext;)Lorg/apache/http/impl/client/RoutedRequest;
    ...
    invoke-interface {v9}, Lorg/apache/http/conn/ManagedClientConnection;->close()V

    iget-object v9, p0, Lorg/apache/http/impl/client/DefaultRequestDirector;->r:Lorg/apache/http/auth/AuthState;

    invoke-virtual {v9}, Lorg/apache/http/auth/AuthState;->getState()Lorg/apache/http/auth/AuthProtocolState;

    move-result-object v9

    sget-object v10, Lorg/apache/http/auth/AuthProtocolState;->CHALLENGED:Lorg/apache/http/auth/AuthProtocolState;

    invoke-virtual {v9, v10}, Lorg/apache/http/auth/AuthProtocolState;->compareTo(Ljava/lang/Enum;)I
    ...
    :cond_6
    :goto_c
    iget-object v9, p0, Lorg/apache/http/impl/client/DefaultRequestDirector;->q:Lorg/apache/http/auth/AuthState;
    ...
    invoke-virtual {v9, v5}, Lorg/apache/http/conn/routing/HttpRoute;->equals(Ljava/lang/Object;)Z
    ...
    :cond_9
    iget-object v2, p0, Lorg/apache/http/impl/client/DefaultRequestDirector;->a:Lorg/apache/http/conn/ClientConnectionManager;

    invoke-interface {v2, v9, v3}, Lorg/apache/http/conn/ClientConnectionManager;->requestConnection(Lorg/apache/http/conn/routing/HttpRoute;Ljava/lang/Object;)Lorg/apache/http/conn/ClientConnectionRequest;
    ...
    invoke-interface {v10, v12, v13, v2}, Lorg/apache/http/conn/ClientConnectionRequest;->getConnection(JLjava/util/concurrent/TimeUnit;)Lorg/apache/http/conn/ManagedClientConnection;

    move-result-object v2

    iput-object v2, p0, Lorg/apache/http/impl/client/DefaultRequestDirector;->p:Lorg/apache/http/conn/ManagedClientConnection;
    :try_end_4
    ...
    const-string/jumbo v10, "Stale connection check"
    ...
    const-string/jumbo v10, "Stale connection detected"
    ...
    invoke-interface {v2, v10}, Lorg/apache/http/client/methods/AbortableHttpRequest;->setConnectionRequest(Lorg/apache/http/conn/ClientConnectionRequest;)V
    :try_end_6
    ...
    iget-object v10, p0, Lorg/apache/http/impl/client/DefaultRequestDirector;->p:Lorg/apache/http/conn/ManagedClientConnection;

    invoke-interface {v2, v10}, Lorg/apache/http/client/methods/AbortableHttpRequest;->setReleaseTrigger(Lorg/apache/http/conn/ConnectionReleaseTrigger;)V
    :try_end_8
    ...
    :cond_d
    iget-object v10, p0, Lorg/apache/http/impl/client/DefaultRequestDirector;->q:Lorg/apache/http/auth/AuthState;

    new-instance v11, Lorg/apache/http/impl/auth/BasicScheme;

    invoke-direct {v11}, Lorg/apache/http/impl/auth/BasicScheme;-><init>()V

    new-instance v12, Lorg/apache/http/auth/UsernamePasswordCredentials;

    invoke-direct {v12, v2}, Lorg/apache/http/auth/UsernamePasswordCredentials;-><init>(Ljava/lang/String;)V

    invoke-virtual {v10, v11, v12}, Lorg/apache/http/auth/AuthState;->update(Lorg/apache/http/auth/AuthScheme;Lorg/apache/http/auth/Credentials;)V
    ...
    :cond_11
    iget-object v2, p0, Lorg/apache/http/impl/client/DefaultRequestDirector;->d:Lorg/apache/http/conn/ConnectionKeepAliveStrategy;
    ...
    invoke-interface {v2, v10, v11, v9}, Lorg/apache/http/conn/ManagedClientConnection;->setIdleDuration(JLjava/util/concurrent/TimeUnit;)V
    ...
    const-string/jumbo v13, "Connection can be kept alive "
    ...
    invoke-interface {v9, v2}, Lorg/apache/commons/logging/Log;->debug(Ljava/lang/Object;)V
    ...
    invoke-static {v9}, Lorg/apache/http/util/EntityUtils;->consume(Lorg/apache/http/HttpEntity;)V

    iget-object v9, p0, Lorg/apache/http/impl/client/DefaultRequestDirector;->p:Lorg/apache/http/conn/ManagedClientConnection;

    invoke-interface {v9}, Lorg/apache/http/conn/ManagedClientConnection;->markReusable()V
    ...
    invoke-virtual {v9}, Lorg/apache/http/auth/AuthState;->getAuthScheme()Lorg/apache/http/auth/AuthScheme;
    ...
    invoke-virtual {v9}, Lorg/apache/http/auth/AuthState;->reset()V
    ...
    :cond_1b
    iget-object v2, p0, Lorg/apache/http/impl/client/DefaultRequestDirector;->n:Lorg/apache/http/client/UserTokenHandler;
    ...
    iget-object v5, p0, Lorg/apache/http/impl/client/DefaultRequestDirector;->p:Lorg/apache/http/conn/ManagedClientConnection;

    invoke-direct {v4, v3, v5, v8}, Lorg/apache/http/conn/BasicManagedEntity;-><init>(Lorg/apache/http/HttpEntity;Lorg/apache/http/conn/ManagedClientConnection;Z)V
