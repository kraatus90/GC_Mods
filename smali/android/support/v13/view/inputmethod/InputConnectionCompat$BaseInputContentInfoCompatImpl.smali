...
.method static handlePerformPrivateCommand(Ljava/lang/String;Landroid/os/Bundle;Landroid/support/v13/view/inputmethod/InputConnectionCompat$OnCommitContentListener;)Z
    ...
    :goto_1
    invoke-virtual {v8, v9, v11}, Landroid/os/ResultReceiver;->send(ILandroid/os/Bundle;)V
    ...
    :cond_4
    invoke-virtual {v8, v10, v11}, Landroid/os/ResultReceiver;->send(ILandroid/os/Bundle;)V
