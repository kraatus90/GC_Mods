...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/motorola/camera/device/callables/CaptureRequestCallable$1;
    }
.end annotation
...
# direct methods
.method static synthetic -get0(Lcom/motorola/camera/device/callables/CaptureRequestCallable;)Lcom/motorola/camera/device/callables/CaptureRequestListener;
    .locals 1

    iget-object v0, p0, Lcom/motorola/camera/device/callables/CaptureRequestCallable;->mCaptureRequestListener:Lcom/motorola/camera/device/callables/CaptureRequestListener;
...
.method static constructor <clinit>()V
    ...
    const-class v0, Lcom/motorola/camera/device/callables/CaptureRequestCallable;

    invoke-virtual {v0}, Ljava/lang/Class;->getSimpleName()Ljava/lang/String;

    move-result-object v0

    sput-object v0, Lcom/motorola/camera/device/callables/CaptureRequestCallable;->TAG:Ljava/lang/String;

    return-void
.end method

.method public constructor <init>(Ljava/lang/String;Landroid/hardware/camera2/CaptureRequest;Lcom/motorola/camera/device/callables/CameraListener;Lcom/motorola/camera/device/callables/CaptureRequestListener;Landroid/os/Handler;)V
    .locals 1
    ...
    new-instance v0, Lcom/motorola/camera/device/callables/CaptureRequestCallable$1;

    invoke-direct {v0, p0}, Lcom/motorola/camera/device/callables/CaptureRequestCallable$1;-><init>(Lcom/motorola/camera/device/callables/CaptureRequestCallable;)V

    iput-object v0, p0, Lcom/motorola/camera/device/callables/CaptureRequestCallable;->mCaptureListener:Landroid/hardware/camera2/CameraCaptureSession$CaptureCallback;
    ...
    iput-object p5, p0, Lcom/motorola/camera/device/callables/CaptureRequestCallable;->mHandler:Landroid/os/Handler;
...
.method public call()Lcom/motorola/camera/device/callables/CallableReturn;
    ...
    invoke-virtual {p0}, Lcom/motorola/camera/device/callables/CaptureRequestCallable;->getCameraData()Lcom/motorola/camera/device/CameraHandlerThread$CameraData;

    move-result-object v0

    iget-object v0, v0, Lcom/motorola/camera/device/CameraHandlerThread$CameraData;->mCameraInfoMap:Ljava/util/Map;

    iget-object v2, p0, Lcom/motorola/camera/device/callables/CaptureRequestCallable;->mCameraId:Ljava/lang/String;
    ...
    sget-object v0, Lcom/motorola/camera/device/callables/CaptureRequestCallable;->TAG:Ljava/lang/String;

    iget-object v3, p0, Lcom/motorola/camera/device/callables/CaptureRequestCallable;->mCaptureRequest:Landroid/hardware/camera2/CaptureRequest;
    ...
    iget-object v0, p0, Lcom/motorola/camera/device/callables/CaptureRequestCallable;->mCaptureListener:Landroid/hardware/camera2/CameraCaptureSession$CaptureCallback;

    :goto_0
    iget-object v4, p0, Lcom/motorola/camera/device/callables/CaptureRequestCallable;->mHandler:Landroid/os/Handler;
